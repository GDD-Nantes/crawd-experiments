...
def main():### Hey Hey hey, remember that you did change the path of the result file directory!!! even this is stupid thing to do
    report_file_name = "/GDD/Thi/sage-jena/wdbench_countdistinct_CHAOLEE_config1.csv"
    result_file_directory = "/GDD/Thi/wdbench_multiple_bgps_count_distinct_CHAOLEE_config1"
