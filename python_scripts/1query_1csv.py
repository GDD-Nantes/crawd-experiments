...
base_dirs = ["/GDD/Thi/sage-jena/wdbench/CRAWD", "/GDD/Thi/sage-jena/wdbench/CHAOLEE"]
...
if __name__ == "__main__":
    #collect_data_from_1_query_CHAOLEE("/GDD/Thi/sage-jena/wdbench/CHAOLEE/top30q/config1/query_137.result", "./query_137.csv")
    main()
