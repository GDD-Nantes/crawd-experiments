...
def plot_data(input_data_files, note_texts_1,note_texts_2, output_plot_file):
    ...
    fig, axes = plt.subplots(nrows=1, ncols=len(input_data_files), figsize=(6.7*3, 2.4*3 ), gridspec_kw={'wspace': 0.1})
    ...
    for i, input_data_file in enumerate(input_data_files):
        ...
        if i==0:
            ...
            ax.text(0.16, 0.95, "PREDICATE", ha='center', va='bottom', transform=ax.transAxes, fontsize=fontsize-2, weight='bold')
